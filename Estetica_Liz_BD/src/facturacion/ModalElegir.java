...
public class ModalElegir extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        btnCorte.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(btnCorte, javax.swing.GroupLayout.DEFAULT_SIZE, 332, Short.MAX_VALUE)
    ...
    private void btnCorteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCorteActionPerformed
        this.dispose();
        if (Principal_administrador.estacerrado(Principal_administrador.lista)) {
            Principal_administrador.lista = new ListaVentas();
            int width = Principal_administrador.escritorio.getWidth();
            int Height = Principal_administrador.escritorio.getHeight();
            Principal_administrador.lista.setSize(width, Height);
            Principal_administrador.escritorio.add(Principal_administrador.lista);
            Principal_administrador.lista.show();
        }
