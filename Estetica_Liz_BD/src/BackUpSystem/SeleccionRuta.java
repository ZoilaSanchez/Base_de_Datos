...
public class SeleccionRuta {
    ...
    FiltrosArchivos filtrotxt;
    FiltrosArchivos filtrolist;
    //

    public SeleccionRuta() {
        filtrolist = new FiltrosArchivos("sql", "Archivos De SQL");
        filtrotxt = new FiltrosArchivos("txt", "Archivos De Texto");
